include Makefile
DYLINX_LIB_WITH_GLUE = -L$(DYLINX_HOME)/build/lib -L.dylinx/lib -latomic -lpthread -ldl -ldlx-init -ldlx-glue
DYLINX_LIB_WO_GLUE = -latomic -lpthread -ldl -ldlx-init
DEFAULT_INCLUDES = -I. -I${DYLINX_HOME}/src/glue -I.dylinx/glue
